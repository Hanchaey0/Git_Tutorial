...
import spring.mvc.pj_117_csg.dto.SoldviewDTO;
...
public class OrderDAOImpl implements OrderDAO{
	...
	//관리자 결산 <상품별 매출액>
	@Override
	public List<SoldviewDTO> adminSoldView() {
		System.out.println("DAO - adminSoldView ");
		
		List<SoldviewDTO> list = sqlSession.selectList("spring.mvc.pj_117_csg.dao.OrderDAO.adminSoldView");
