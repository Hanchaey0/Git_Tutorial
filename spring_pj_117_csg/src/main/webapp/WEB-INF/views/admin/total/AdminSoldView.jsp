		...
		<div id="container">
			<div id="contents">
				...
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">		
						...
						<tbody>
  							<c:forEach var="dto" items="${list}" varStatus="status">
								<tr class="sold_info">
									...
									<td><input type="hidden" class="totalCnt" id="totalCnt" value="${dto.totalCnt}"><fmt:formatNumber  value="${dto.totalCnt}" groupingUsed="true"/>개</td>
									<td><input type="hidden" class="totalMoney" id="totalMoney" value="${dto.totalMoney}"><fmt:formatNumber value="${dto.totalMoney}" pattern="\#,###.##"/>원</td>
					...
					<div id="chart_Money" style="width:800px; height:500px;"></div>
				</form>
			</div>
